...
/**
 * Returns true if the type value is an instance of the passed in constructor
...
/**
 * Asserts that the type value is an instance of the passed in constructor. If
 * the assertion fails a TypeError is thrown otherwise type.assert is returned.
 * @param   {function} constructor
 * @returns {object}
 */
...
/**
 * Asserts that the type value has a length equal to the passed in value. If the
 * assertion fails a TypeError is thrown otherwise type.assert is returned.
 * @param   {number} n
 * @returns {object}
 */
